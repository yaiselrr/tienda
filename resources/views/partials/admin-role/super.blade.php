...
<li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="homepage" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-ps-right-banner') }}"><span>{{ __('Right Side Banner') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-service-index') }}"><span>{{ __('Services') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-ps-best-seller') }}"><span>{{ __('Left Side Banner1') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-ps-big-save') }}"><span>{{ __('Left Side Banner2') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-sb-large') }}"><span>{{ __('Bottom Large Banners') }}</span></a>
            </li>
            <li>
