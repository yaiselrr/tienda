	...
	<a href="{{ route('front.product', $prod->slug) }}" class="single-product">
		<div class="img">
			...
			<div class="box">
				...
				<ul class="action-meta">
					...
					@else
						...
						<li>
							<span class="cart-btn quick-view" data-href="{{ route('product.quick',$prod->id) }}" rel-toggle="tooltip" data-placement="top" title="{{ __('Add To Cart') }}" data-toggle="modal" data-target="#quickview">
