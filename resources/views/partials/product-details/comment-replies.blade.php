...
<div class="write-comment-area">
  <form id="comment-form" action="{{ route('product.comment') }}" method="POST">
    ...
    <div class="row">
      <div class="col-lg-12">
      <textarea placeholder="{{ __('Write Your Comments Here...') }}" name="text" required></textarea>
      </div>
    </div>
    <div class="row">
      <div class="col-lg-12">
...
<div class="col-lg-12">
<br>
  <h5 class="text-center"><a href="javascript:;" data-toggle="modal" data-target="#user-login" class="btn login-btn">{{ __('Login') }}</a> {{ __('To Comment') }} </h5>
<br>
</div>
</div>
