...
class FlutterwaveController extends CheckoutBaseControlller
{
    ...
    public function store(Request $request)
    {
        ...
        file_put_contents(storage_path().'/flutter/'.$order['item_number'].'.json', $session_datas); 
    ...
    public function notify(Request $request)
    {
        ...
        if(file_exists(storage_path().'/flutter/'.$input_data['txref'].'.json')){
            $data_results = file_get_contents(storage_path().'/flutter/'.$input_data['txref'].'.json');
            $lang = json_decode($data_results, true);
            foreach($lang as $key => $lan){
                Session::put(''.$key,$lan);
            }
            unlink(storage_path().'/flutter/'.$input_data['txref'].'.json');
        }
