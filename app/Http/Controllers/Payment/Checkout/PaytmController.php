...
class PaytmController extends CheckoutBaseControlller
{
    ...
    public function store(Request $request)
    {
        ...
        file_put_contents(storage_path().'/paytm/'.$order['item_number'].'.json', $session_datas); 
    ...
    public function notify(Request $request)
    {
        ...
        if(file_exists(storage_path().'/paytm/'.$input_data['ORDERID'].'.json')){
            $data_results = file_get_contents(storage_path().'/paytm/'.$input_data['ORDERID'].'.json');
            $lang = json_decode($data_results, true);
            foreach($lang as $key => $lan){
                Session::put(''.$key,$lan);
            }
            unlink(storage_path().'/paytm/'.$input_data['ORDERID'].'.json');
        }
